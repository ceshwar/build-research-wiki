...
export const HOW_TO_SECTIONS = [
  ...
  },
  {
    ...
    terms: [
      ...
      { name: 'Map', desc: 'Charted items for the active dock — **List** table or **By theme** (portfolio). Expand **Note** for one-liner + PDF. Toggle **Edit** (List only) to remove papers from the chart.' },
