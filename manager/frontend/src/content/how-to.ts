...
export const HOW_TO_SECTIONS = [
  {
    ...
    body: [
      ...
      'A **dock** auto-selects and opens the **workspace** on **Map**.',
      'Click the **dock name** in the path (`Reef › Dock`) to switch docks or upload.',
  ...
  },
  {
    ...
    terms: [
      ...
      { name: 'Workspace', desc: 'Focused view after picking a dock: `Reef › Dock` path + tabs (Map · Chart status · Actions). Only one tab visible at a time.' },
