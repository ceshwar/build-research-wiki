...
export const HOW_TO_SECTIONS = [
  {
    ...
    body: [
      ...
      'Choose a **dock** (channel), upload PDFs if needed, then **Update chart** for Quick Dip.',
  ...
  },
  {
    ...
    terms: [
      ...
      { name: 'Dive Computer', desc: 'Status dashboard — on chart, awaiting chart, quick dip, enrich next.' },
