...
export const HOW_TO_SECTIONS = [
  {
    ...
    body: [
      ...
      'Choose a **dock** — first visit opens **Map**; use the rail for **Map** vs **Chart & enrich**.',
  ...
  },
  {
    ...
    terms: [
      ...
      { name: 'Map', desc: 'Charted items for the active dock — expand **Note** on a paper for its one-liner and PDF link.' },
      { name: 'Dock workspace', desc: 'Rail under docks: **Map** first, then **Chart & enrich** (Chart status + Actions). Not sticky — scrolls away.' },
