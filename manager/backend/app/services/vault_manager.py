    ...
    def _stats(self, vault_path: Path) -> dict:
        ...
        for cs in channels:
            ...
            cs.update({
                ...
                "needs_review": counts.get("quick_dip_review", 0),
                "uncharted_count": counts.get("uncharted_territory", 0),
                "quick_dip_review_count": counts.get("quick_dip_review", 0),
        ...
        return {
            ...
            "needs_review_count": totals.get("quick_dip_review", 0),
            "uncharted_count": totals.get("uncharted_territory", 0),
            "quick_dip_review_count": totals.get("quick_dip_review", 0),
